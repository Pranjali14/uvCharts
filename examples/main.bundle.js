...
/***/ function(module, exports, __webpack_require__) {
	...
	var dashboard_module_1 = __webpack_require__(25);
	var core_module_1 = __webpack_require__(95);
	var app_routes_module_1 = __webpack_require__(96);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dashboard_1 = __webpack_require__(91);
	var routes = [
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	     true ? factory(exports, __webpack_require__(3), __webpack_require__(60), __webpack_require__(4), __webpack_require__(5), __webpack_require__(54)) :
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var line_chart_1 = __webpack_require__(62);
	var area_chart_1 = __webpack_require__(68);
	var stacked_bar_chart_1 = __webpack_require__(71);
	var percent_bar_chart_1 = __webpack_require__(74);
	var percent_area_chart_1 = __webpack_require__(77);
	var pie_chart_1 = __webpack_require__(80);
	var donut_chart_1 = __webpack_require__(83);
	var waterfall_chart_1 = __webpack_require__(84);
	var polar_area_chart_1 = __webpack_require__(85);
	var stepup_bar_chart_1 = __webpack_require__(86);
	var bar_chart_1 = __webpack_require__(87);
	var stacked_area_chart_1 = __webpack_require__(88);
	exports.uvComponents = [
	    line_chart_1.LineChartComponent,
	    area_chart_1.AreaChartComponent,
	    stacked_bar_chart_1.StackedBarChartComponent,
	    percent_bar_chart_1.PercentBarChartComponent,
	    percent_area_chart_1.PercentAreaChartComponent,
	    pie_chart_1.PieChartComponent,
	    donut_chart_1.DonutChartComponent,
	    waterfall_chart_1.WaterfallChartComponent,
	    polar_area_chart_1.PolarAreaChartComponent,
	    stepup_bar_chart_1.StepupBarChartComponent,
	    bar_chart_1.BarChartComponent,
	    stacked_area_chart_1.StackedAreaChartComponent
	];
	var EntryComponents = (function () {
	    function EntryComponents() {
	    }
	    EntryComponents.prototype.getComponentForChartType = function (type) {
	        var cmp;
	        if (type === 'line-chart') {
	            cmp = line_chart_1.LineChartComponent;
	        }
	        else if (type === 'stacked-bar-chart') {
	            cmp = stacked_bar_chart_1.StackedBarChartComponent;
	        }
	        else if (type === 'area-chart') {
	            cmp = area_chart_1.AreaChartComponent;
	        }
	        else if (type === 'percent-bar-chart') {
	            cmp = percent_bar_chart_1.PercentBarChartComponent;
	        }
	        else if (type === 'percent-area-chart') {
	            cmp = percent_area_chart_1.PercentAreaChartComponent;
	        }
	        else if (type === 'pie-chart') {
	            cmp = pie_chart_1.PieChartComponent;
	        }
	        else if (type === 'donut-chart') {
	            cmp = donut_chart_1.DonutChartComponent;
	        }
	        else if (type === 'waterfall-chart') {
	            cmp = waterfall_chart_1.WaterfallChartComponent;
	        }
	        else if (type === 'polar-area-chart') {
	            cmp = polar_area_chart_1.PolarAreaChartComponent;
	        }
	        else if (type === 'stepup-bar-chart') {
	            cmp = stepup_bar_chart_1.StepupBarChartComponent;
	        }
	        else if (type === 'bar-chart') {
	            cmp = bar_chart_1.BarChartComponent;
	        }
	        else if (type === 'stacked-area-chart') {
	            cmp = stacked_area_chart_1.StackedAreaChartComponent;
	        }
	        return cmp;
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LineChartComponent = (function () {
	    function LineChartComponent(commonService) {
	        this.commonService = commonService;
	        this.uv = commonService.uv;
	    }
	    LineChartComponent.prototype.ngOnInit = function () {
	        var _this = this;
	        this.commonService.getRealTimeData('line-chart').subscribe(function (data) { _this.data = data; _this.makeChart(_this.data); });
	    };
	    LineChartComponent.prototype.makeChart = function (data) {
	        this.metaData = {
	            graph: {
	    ...
	    ], LineChartComponent.prototype, "compress", void 0);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommonService = (function () {
	    ...
	    CommonService.prototype.getChartData = function (chartType) {
	        switch (chartType) {
	    ...
	    CommonService.prototype.getRealTimeData = function (chartType) {
	        var _this = this;
	        return this.http.get(this.url)
	            .map(function (res) { return _this.extractData(res, _this, chartType); });
	    };
	    CommonService.prototype.getTemperature = function (chartType) {
	        var _this = this;
	        var url = "https://data.gov.in/api/datastore/resource.json?resource_id=863d77b2-a35c-44c4-aaaf-8b3a19fc8e0e&api-key=13abddd93f0ecebd6eab10dd65088766&filters[YEAR]=2005,2006,2007,2009,2008,2010,2011,2012,2013,2014&fields=ANNUALMIN,ANNUALMAX,YEAR&sort[YEAR]=asc";
	        return this.http.get(url)
	            .map(function (res) { return _this.extractDataCommon(res, _this, chartType); });
	    };
	    CommonService.prototype.getForestAreaCover = function (chartType) {
	        var _this = this;
	        var url = "https://data.gov.in/api/datastore/resource.json?resource_id=b91dca24-12df-420e-816d-656464e5f3e8&api-key=13abddd93f0ecebd6eab10dd65088766&filters[stateut]=Rajasthan,Maharashtra,Uttar%20Pradesh,Jammu%20and%20Kashmir,Gujarat,Karnataka&fields=stateut,2011_assessment_open_forest,2011_assessment_mod__dense_forest,2011_assessment_very_dense_forest,geographical_area&sort[geographical_area]=desc";
	        return this.http.get(url).map(function (res) { return _this.extractForestCoverData(res, _this, chartType); });
	    };
	    CommonService.prototype.getHorticultureProduction = function (chartType) {
	        var _this = this;
	        ...
	        return this.http.get(url).map(function (res) { return _this.extractHorticultureData(res, _this, chartType); });
	    };
	    CommonService.prototype.getTotalHorticultureProduction = function (chartType) {
	        var _this = this;
	        ...
	        return this.http.get(url).map(function (res) { return _this.extractTotalHorticultureData(res, _this, chartType); });
	    };
	    CommonService.prototype.extractTotalHorticultureData = function (res, thizz, chartType) {
	        var data = res.json().records;
	        var categories = ['Vegetables', 'Fruits', 'Spices', 'Plantation Crops'];
	        var dataset = { 'Vegetables': [], 'Fruits': [], 'Spices': [], 'Plantation Crops': [] };
	        var dataObj = {};
	    ...
	    CommonService.prototype.extractHorticultureData = function (res, thizz, chartType) {
	        var data = res.json().records;
	        var categories = ['Horticulture'];
	        var dataset = { 'Horticulture': [] };
	        var dataObj = {};
	    ...
	    CommonService.prototype.extractForestCoverData = function (res, thizz, chartType) {
	        var data = res.json().records;
	        var categories = ['Very Dense', 'Moderate Dense', 'Open'];
	        var dataset = { 'Very Dense': [], 'Moderate Dense': [], 'Open': [] };
	        var dataObj = {};
	    ...
	    CommonService.prototype.extractDataCommon = function (res, thizz, chartType) {
	        var data = res.json().records;
	        var categories = ['ANNUALMIN', 'ANNUALMAX'];
	        var dataset = { 'ANNUALMIN': [], 'ANNUALMAX': [] };
	        var dataObj = {};
	    ...
	    CommonService.prototype.getData = function (chartType) {
	        var graphdef = {
	    ...
	    CommonService.prototype.extractData = function (res, thizz, chartType) {
	        var data = res.json();
	    ...
	    CommonService.prototype.getChartDescription = function (chartType) {
	        switch (chartType) {
	            case 'area-chart':
	    ...
	    CommonService.prototype.getChartTypeName = function (chartType) {
	        switch (chartType) {
	            case 'area-chart':
	                return 'Area Chart';
	            case 'line-chart':
	    ...
	    CommonService.prototype.setCachedData = function (data, chartType) {
	        this.cachedGraphData[chartType] = {};
	        this.cachedGraphData[chartType].data = data;
	    };
	    CommonService.prototype.getCachedData = function (chartType) {
	        return this.cachedGraphData &&
	            this.cachedGraphData[chartType] &&
	            this.cachedGraphData[chartType].data;
	    };
	    CommonService.prototype.updatePalette = function (chartType, data) {
	    ...
	    CommonService.prototype.setCachedMetaData = function (chartType, data) {
	        this.cachedGraphData[chartType].metaData = data;
	    };
	    CommonService.prototype.getCachedMetaData = function (chartType) {
	        return this.cachedGraphData &&
	            this.cachedGraphData[chartType] &&
	            this.cachedGraphData[chartType].metaData;
	    };
	    CommonService.prototype.getChartKey = function (chartType) {
	        var dataList = {
	            'line-chart': {
	                key: 'line',
	                domRef: 'line-chart',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AreaChartComponent = (function () {
	    function AreaChartComponent(commonService) {
	        this.commonService = commonService;
	        this.uv = commonService.uv;
	    }
	    AreaChartComponent.prototype.ngOnInit = function () {
	        var _this = this;
	        this.commonService.getRealTimeData('area-chart').subscribe(function (data) { _this.data = data; _this.makeChart(_this.data); });
	    };
	    AreaChartComponent.prototype.makeChart = function (data) {
	        this.metaData = {
	            graph: {
	                orientation: 'Vertical'
	            },
	    ...
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', Boolean)
	    ], AreaChartComponent.prototype, "compress", void 0);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StackedBarChartComponent = (function () {
	    function StackedBarChartComponent(commonService) {
	        this.commonService = commonService;
	        this.uv = commonService.uv;
	    }
	    StackedBarChartComponent.prototype.ngOnInit = function () {
	        var _this = this;
	        this.commonService.getForestAreaCover('stacked-bar-chart').subscribe(function (data) { _this.data = data; _this.makeChart(_this.data); });
	    };
	    StackedBarChartComponent.prototype.makeChart = function (data) {
	        this.metaData = {
	            meta: {
	    ...
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', Boolean)
	    ], StackedBarChartComponent.prototype, "compress", void 0);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PercentBarChartComponent = (function () {
	    function PercentBarChartComponent(commonService) {
	        this.commonService = commonService;
	        this.uv = commonService.uv;
	    }
	    PercentBarChartComponent.prototype.ngOnInit = function () {
	        var _this = this;
	        this.commonService.getTotalHorticultureProduction('percent-bar-chart').subscribe(function (data) { _this.data = data; _this.makeChart(_this.data); });
	    };
	    PercentBarChartComponent.prototype.makeChart = function (data) {
	        this.metaData = {
	            meta: {
	    ...
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', Boolean)
	    ], PercentBarChartComponent.prototype, "compress", void 0);
	    PercentBarChartComponent = __decorate([
	        core_1.Component({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(3);
	var common_service_1 = __webpack_require__(63);
	var PercentAreaChartComponent = (function () {
	    function PercentAreaChartComponent(commonService) {
	        this.commonService = commonService;
	        this.uv = commonService.uv;
	    }
	    PercentAreaChartComponent.prototype.ngOnInit = function () {
	        var _this = this;
	        this.commonService.getTotalHorticultureProduction('percent-area-chart').subscribe(function (data) { _this.data = data; _this.makeChart(_this.data); });
	    };
	    PercentAreaChartComponent.prototype.makeChart = function (data) {
	        this.metaData = {
	            meta: {
	    ...
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', Boolean)
	    ], PercentAreaChartComponent.prototype, "compress", void 0);
	    PercentAreaChartComponent = __decorate([
	        core_1.Component({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PieChartComponent = (function () {
	    function PieChartComponent(commonService) {
	        this.commonService = commonService;
	        this.uv = commonService.uv;
	    }
	    PieChartComponent.prototype.ngOnInit = function () {
	        var _this = this;
	        this.commonService.getHorticultureProduction('pie-chart').subscribe(function (data) { _this.data = data; _this.makeChart(_this.data); });
	    };
	    PieChartComponent.prototype.makeChart = function (data) {
	        this.metaData = {
	            meta: {
	    ...
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', Boolean)
	    ], PieChartComponent.prototype, "compress", void 0);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DonutChartComponent = (function () {
	    function DonutChartComponent(commonService) {
	        this.commonService = commonService;
	        this.uv = commonService.uv;
	    }
	    DonutChartComponent.prototype.ngOnInit = function () {
	        var _this = this;
	        this.commonService.getHorticultureProduction('donut-chart').subscribe(function (data) { _this.data = data; _this.makeChart(_this.data); });
	    };
	    DonutChartComponent.prototype.makeChart = function (data) {
	        this.metaData = {
	            meta: {
	                position: '#donut-div',
	                caption: 'Horticulture Production in India during 2010-11'
	    ...
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', Boolean)
	    ], DonutChartComponent.prototype, "compress", void 0);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WaterfallChartComponent = (function () {
	    ...
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', Boolean)
	    ], WaterfallChartComponent.prototype, "compress", void 0);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PolarAreaChartComponent = (function () {
	    function PolarAreaChartComponent(commonService) {
	        this.commonService = commonService;
	        this.uv = commonService.uv;
	    }
	    PolarAreaChartComponent.prototype.ngOnInit = function () {
	        var _this = this;
	        this.commonService.getHorticultureProduction('polar-area-chart').subscribe(function (data) { _this.data = data; _this.makeChart(_this.data); });
	    };
	    PolarAreaChartComponent.prototype.makeChart = function (data) {
	        this.metaData = {
	            meta: {
	    ...
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', Boolean)
	    ], PolarAreaChartComponent.prototype, "compress", void 0);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(3);
	var common_service_1 = __webpack_require__(63);
	var StepupBarChartComponent = (function () {
	    function StepupBarChartComponent(commonService) {
	        this.commonService = commonService;
	        this.uv = commonService.uv;
	    }
	    StepupBarChartComponent.prototype.ngOnInit = function () {
	        var _this = this;
	        this.commonService.getForestAreaCover('stepup-bar-chart').subscribe(function (data) { _this.data = data; _this.makeChart(_this.data); });
	    };
	    StepupBarChartComponent.prototype.makeChart = function (data) {
	        this.metaData = {
	            meta: {
	    ...
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', Boolean)
	    ], StepupBarChartComponent.prototype, "compress", void 0);
	    StepupBarChartComponent = __decorate([
	        core_1.Component({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BarChartComponent = (function () {
	    function BarChartComponent(commonService) {
	        this.commonService = commonService;
	        this.uv = commonService.uv;
	    }
	    BarChartComponent.prototype.ngOnInit = function () {
	        var _this = this;
	        this.commonService.getTemperature('bar-chart').subscribe(function (data) { _this.data = data; _this.makeChart(_this.data); });
	    };
	    BarChartComponent.prototype.makeChart = function (data) {
	        this.metaData = {
	            graph: {
	                orientation: 'Vertical',
	    ...
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', Boolean)
	    ], BarChartComponent.prototype, "compress", void 0);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StackedAreaChartComponent = (function () {
	    function StackedAreaChartComponent(commonService) {
	        this.commonService = commonService;
	        this.uv = commonService.uv;
	    }
	    StackedAreaChartComponent.prototype.ngOnInit = function () {
	        var _this = this;
	        this.commonService.getTotalHorticultureProduction('stacked-area-chart').subscribe(function (data) { _this.data = data; _this.makeChart(_this.data); });
	    };
	    StackedAreaChartComponent.prototype.makeChart = function (data) {
	        this.metaData = {
	            meta: {
	    ...
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', Boolean)
	    ], StackedAreaChartComponent.prototype, "compress", void 0);
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"container\">\n\t<div class=\"item item-br\">\n\t\t<percent-area-chart [routerLink]=\"['/chart/percent-area-chart']\" [compress]=\"true\"></percent-area-chart>\n\t\t<div>Percent Area Chart</div>\n\t</div>\n\t<div class=\"item\">\n\t\t<area-chart [routerLink]=\"['/chart/area-chart']\" [compress]=\"true\"></area-chart>\n\t\t<div>Area Chart</div>\n\t</div>\n\t<div class=\"item\">\n\t\t<stacked-bar-chart [routerLink]=\"['/chart/stacked-bar-chart']\" [compress]=\"true\"></stacked-bar-chart>\n\t\t<div>Stacked Bar Chart</div>\n\t</div>\n\t<div class=\"item\">\n\t\t<pie-chart [routerLink]=\"['/chart/pie-chart']\" [compress]=\"true\"></pie-chart>\n\t\t<div>Pie Chart</div>\n\t</div>\n</div>\n<div class=\"container\">\n\t<div class=\"item item-br\">\n\t\t<line-chart [routerLink]=\"['/chart/line-chart']\" [compress]=\"true\"></line-chart>\n\t\t<p>Line Chart</p>\n\t</div>\n\t<div class=\"item\">\n\t\t<donut-chart [routerLink]=\"['/chart/donut-chart']\" [compress]=\"true\"></donut-chart>\n\t\t<div>Donut Chart</div>\n\t</div>\n\t<div class=\"item\">\n\t\t<waterfall-chart [routerLink]=\"['/chart/waterfall-chart']\" [compress]=\"true\"></waterfall-chart>\n\t\t<div>Waterfall Chart</div>\n\t</div>\n\t<div class=\"item\">\n\t\t<percent-bar-chart [routerLink]=\"['/chart/percent-bar-chart']\" [compress]=\"true\"></percent-bar-chart>\n\t\t<div>Percent Bar Chart</div>\n\t</div>\n</div>\n<div class=\"container\">\n\t<div class=\"item item-br\">\n\t\t<polar-area-chart [routerLink]=\"['/chart/polar-area-chart']\" [compress]=\"true\"></polar-area-chart>\n\t\t<div>Polar Area Chart</div>\n\t</div>\n\t<div class=\"item\">\n\t\t<stepup-bar-chart [routerLink]=\"['/chart/stepup-bar-chart']\" [compress]=\"true\"></stepup-bar-chart>\n\t\t<div>Stepup Bar Chart</div>\n\t</div>\n\t<div class=\"item\">\n\t\t<bar-chart [routerLink]=\"['/chart/bar-chart']\" [compress]=\"true\"></bar-chart>\n\t\t<div>Bar Chart</div>\n\t</div>\n\t<div class=\"item\">\n\t\t<stacked-area-chart [routerLink]=\"['/chart/stacked-area-chart']\" [compress]=\"true\"></stacked-area-chart>\n\t\t<div>Stacked Area Chart</div>\n\t</div>\n</div>"
	    ...
	    { path: '', redirectTo: 'dashboard', pathMatch: 'full' },
	    {
	        path: 'chart', loadChildren: function () { return new Promise(function (resolve) {
	            __webpack_require__.e/* nsure */(1, function (require) {
	                resolve(__webpack_require__(97)['default']);
	            });
	        }); }
	    }
	];
